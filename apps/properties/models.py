...
class PropertyPublishManager(models.Manager):
    def get_queryset(self):
        return (super(PropertyPublishManager, self).get_queryset().filter(publish_status=True))
...
class Property(TimeStampUUIDModel):
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Bangalore")
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=100, default="103")
    street_address = models.CharField(verbose_name=("Street Adress"), max_length=150, default="HSR Layout")
    property_number = models.IntegerField(verbose_name=("House Number"),
    ...
    def final_property_price(self):
        ...
        tax_amount = rount(tax_percentage*property_price, 2)
        price_after_tax = float(round(property_price+tax_amount, 2))
        return price_after_tax


class PropertyView(TimeStampUUIDModel):
