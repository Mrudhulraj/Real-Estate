...
class Profile(TimeStampUUIDModel):
    ...
    license = models.CharField(verbose_name=_("Real Estate License"), max_length=20, blank=True)
    ...
    city = models.CharField(verbose_name=_("City"), max_length=128, default="Bangalore", blank=False, null=False)
    is_buyer = models.BooleanField(verbose_name=_("Buyer"), default=False,
                                   help_text=_("Are you looking for buying property"))
